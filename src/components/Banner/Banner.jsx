...
const Banner = () => {
  ...
  return (
    <div className="grid grid-cols-1 gap-2 w-full mx-auto h-[40vh] md:h-screen rounded-2xl p-5 overflow-hidden">
      <div  data-aos="fade-up" className="col-span-1 border rounded-xl overflow-hidden">
        <Swiper
          spaceBetween={30}
          pagination={{
            clickable: true,
